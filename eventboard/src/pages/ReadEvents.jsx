  ...
  return (
    <div className='read-events-container'>
      <div className='filter-options'>
        <label style={{ backgroundColor: adaFilter ? '#003459' : 'transparent', color: adaFilter ? 'white' : 'black', transition: 'background-color 0.3s ease'}}>
        ...
        <label style={{ backgroundColor: unisexFilter ? '#003459' : 'transparent', color: unisexFilter ? 'white' : 'black', transition: 'background-color 0.3s ease'     }}>
